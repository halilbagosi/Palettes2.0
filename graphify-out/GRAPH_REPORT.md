...
## Corpus Check
- 53 files · ~28,623 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 507 nodes · 805 edges · 70 communities (35 shown, 35 thin omitted)
...
Cohesion: 0.07
Nodes (36): ColorBindingWrapper, Hashable, Identifiable, IndexSet, AppData, PaletteExportView, PaletteImageRenderer, UIImage (+28 more)

### Community 1 - "Toast & UI Components"
Cohesion: 0.23
Nodes (12): AttributedString, highlightedText(), HueChip, RecentSearchesRow, SearchEmptyLibraryView, SearchEmptyStateView, SearchSectionHeader, Bool (+4 more)
...
Cohesion: 0.24
Nodes (7): View, PaletteCell, Color, String, Void, PaletteTabView, PaletteView
...
Cohesion: 0.07
Nodes (26): AnyShapeStyle, DispatchWorkItem, FoundationModels, Never, ObservableObject, copyToClipboard(), Bool, String (+18 more)
...
Cohesion: 0.32
Nodes (6): Color, ColorCellBig, Bool, Color, String, Void
...
Cohesion: 0.19
Nodes (6): Combine, Foundation, LocalizedStringKey, Color, viewButtonCell, SwiftUI

### Community 31 - "ToastOverlay"
Cohesion: 0.27
Nodes (12): BaseColor, GeneratedColor, GeneratedPalette, LockedColor, PaletteGenerator, Color, Int, MainActor (+4 more)

### Community 32 - "PaletteCell"
Cohesion: 0.20
Nodes (9): ColorBindingWrapper, NewPaletteView, Binding, Bool, CGFloat, Color, Int, Set (+1 more)
...
- **Why does `View` connect `App Entry & Shaders` to `Color Data Model`, `Toast & UI Components`, `Palette Export & Rendering`, `Toast Manager & Input Modes`, `Color Edit View`, `Generate View (AI Palette UI)`, `Interactive Color Picker`, `AdjustmentSlider`, `Palette Generator (Foundation Models)`, `Editable Values View`, `Big Color Cell`, `ColorInputView`, `GenerationOrbView`, `GenerationResultView`, `PaletteShaders.metal`, `PaletteCell`, `PaletteCellSearch`, `ColorCellSearch`, `PaletteEmptyView`, `SparkleFieldView`?**
  _High betweenness centrality (0.244) - this node is a cross-community bridge._
- **Why does `SwiftUI` connect `PaletteShaders.metal` to `Color Data Model`, `Toast & UI Components`, `Palette Export & Rendering`, `App Entry & Shaders`, `Toast Manager & Input Modes`, `Share Sheet & Camera Picker`, `New Palette Creation Flow`, `Color Edit View`, `Interactive Color Picker`, `App Error Types`, `AdjustmentSlider`, `Palette Generator (Foundation Models)`, `Editable Values View`, `Big Color Cell`, `ColorInputView`, `GenerationOrbView`, `GenerationResultView`, `ColorAdjustment`, `ToastOverlay`, `PaletteCell`, `PaletteCellSearch`, `ColorCellSearch`, `MyApp`, `PaletteEmptyView`, `SparkleFieldView`?**
  _High betweenness centrality (0.216) - this node is a cross-community bridge._
- **Why does `AppData` connect `Color Data Model` to `PaletteCell`, `App Entry & Shaders`, `Toast Manager & Input Modes`, `Color Edit View`, `Palette Generator (Foundation Models)`, `Palette Tab Navigation`, `ColorInputView`, `GenerationResultView`, `PaletteShaders.metal`?**
